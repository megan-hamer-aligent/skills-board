...
export const INITIAL_SKILLS: Skill[] = [
  ...
  // ── DELIVER ───────────────────────────────────────────────────────────────
  {
    ...
    seniorStatus: 'not-yet',
    seniorGrowthNotes: [
      'Proactively identifying and acting on opportunities for project and deliverable improvement independently',
      'Anticipating risks and preemptively acting on them before they affect the team',
      'Delegating work effectively based on task relevance, capacity, and priority - including handover, support, review, feedback, and delivery',
      'Removing blockers for others and actively supporting the team to find solutions',
    ],
    examples: [],
  },
  {
